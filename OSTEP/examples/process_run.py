...
# python3 process_run.py -l 4:100,1:0 -p -c
# python3 process_run.py -l 5:80,5:100 -p -c
# python3 process_run.py -l 1:0,4:100 -c -S SWITCH_ON_END
# python3 process_run.py -l 3:0,5:100,5:100,5:100 -I IO_RUN_LATER -c -p
# python3 process_run.py -l 3:0,5:100,5:100,5:100 -I IO_RUN_IMMEDIATE -c -p

# python3 process_run.py -l 5:100,1:0 -c -p -I IO_RUN_LATER
# is different from
# python3 process_run.py -l 1:0,5:100 -c -p -I IO_RUN_LATER
